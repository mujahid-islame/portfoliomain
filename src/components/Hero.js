...
// Social Icons Components (Component-এর বাইরে রাখলে পারফরম্যান্স ভালো হয়)
const GithubIcon = () => (
...
const Hero = () => {
  ...
  // টাইপিং অ্যানিমেশনের নতুন টেক্সট
  const texts = [
    "Mujahid Islam",
    "Flutter Developer",
  ...
  // নতুন Flutter & State Management ব্যাজ ডেটা
  const floatingIcons = [
  ...
  // স্প্রিং অ্যানিমেশন স্মুথ করার জন্য কাস্টমাইজড সেটিংস
    ...
    >
      ...
      <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-16 items-center z-10">
        ...
        <div className="flex flex-col gap-10 text-center lg:text-left">
          ...
          >
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="group relative px-8 py-4 bg-slate-900 text-white font-bold rounded-2xl overflow-hidden transition-all shadow-xl shadow-slate-900/10"
            >
              <span className="relative z-10 flex items-center gap-2">
        ...
        <div className="relative flex justify-center perspective-1000">
          ...
          >
            {/* New State Management & Flutter Badges */}
            {floatingIcons.map((icon, index) => (
              <motion.div
                key={icon.name}
                animate={{ y: [0, -15, 0] }}
